   ...
   <div>
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            ...
            <div class="container mx-auto px-6 py-8">
                <h2 class="mb-4 text-2xl font-bold">Management</h2>

                <div class="flex justify-start gap-4">
                    <a href="{{ route('admin.users.index')}}" class="flex items-center rounded-xl bg-white p-4 shadow-lg">
                    ...
                    <a href="{{ route('admin.management') }}" class="flex items-center rounded-xl bg-white p-4 shadow-lg">
                        <div class="flex h-12 w-12 items-center justify-center rounded-full border border-blue-100 bg-blue-50">
                        ...
                        <div class="ml-4">
                            <h2 class="font-semibold">Form Management</h2>

                        </div>
                    </a>

                    <a href="{{ route('admin.announcement.show') }}" class="flex items-center rounded-xl bg-white p-4 shadow-lg">
                ...
                <br>
                <h2 class="mb-4 text-2xl font-bold">Validate Information</h2>
                <div class="flex justify-start gap-4">
                     <a href="{{ route('admin.project.status')}}" class="flex items-center rounded-xl bg-white p-4 shadow-lg">
                        <div class="flex h-12 w-12 items-center justify-center rounded-full border border-blue-100 bg-blue-50">
                    ...
                    <a href="{{ route('admin.submission')}}" class="flex items-center rounded-xl bg-white p-4 shadow-lg">
                        <div class="flex h-12 w-12 items-center justify-center rounded-full border border-orange-100 bg-orange-50">
