                                    ...
                                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2 justify-center">
                                                <div>
                                                    @if( (!empty($job_pro['processed'])) || ($current_date >= $job_pro['end_date']) )

                                                    @else
                                                    <a href="{{ route('student.submit.meeting', $job_pro['id']) }}" type="button" class="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
