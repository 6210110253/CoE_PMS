    ...
    <main class="bg-white font-montserrat">
        ...
        <header class="h-24 sm:h-32 flex items-center">
            <div class="container mx-auto px-6 sm:px-12 flex items-center justify-between">
                <div class="text-black font-black text-2xl flex items-center">
                    <span class="w-6 h-6 rounded-full bg-blue-500 mr-4"></span> CoE PMS
                </div>
        ...
        <div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row items-center">
            <div class="sm:w-2/5 flex flex-col items-start mt-8 sm:mt-0">
                <h1 class="text-4xl lg:text-6xl leading-none mb-4"><strong class="font-black">CoE PMS</strong> </h1>
                <p class="lg:text-lg mb-4 sm:mb-12">Web application for management and maintain information about projects of computer engineering students</p>
                <a href="https://www.coe.psu.ac.th/" target="_blank" class="font-semibold text-lg bg-blue-500 hover:bg-blue-400 text-white py-3 px-10 rounded-full">Go to CoE website</a>
            </div>
        ...
        {{-- <div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row items-center">
            <div class="flex flex-justify-center gap-4 mx-auto px-6">
                ...
                <a  class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">240-308 <span class="text-sm">2(0-6-0)</span></h5>
                    <h5 class="text-center mb-2 text-sm font-bold tracking-tight text-gray-900 dark:text-white">COMPUTER ENGINEERING PROJECT PREPARATION</h5>

                    <p class="font-normal text-gray-700 dark:text-gray-400">
                        มีรายวิชาเรียนก่อน ที่ต้องเรียนผ่านได้เกรด <br> A, B+, B, C+ ,C ,D+ ,D ,T ,S, P, G
                        <br>
                        - 240-207 PROGRAM & DATA STRUCTURES
                        <br>
                        - 240-208 DIGITAL LOGIC AND DESIGN</p>
                </a>

                <a  class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">240-401 <span class="text-sm">3(0-9-0)</span></h5>
                    <h5 class="text-center mb-2 text-sm font-bold tracking-tight text-gray-900 dark:text-white">COMPUTER ENGINEERING PROJECT I</h5>
                    <p class="font-normal text-gray-700 dark:text-gray-400">
                        มีรายวิชาเรียนก่อน ที่ต้องเรียนผ่านได้เกรด
                        <br>A, B+, B, C+ ,C ,D+ ,D ,T ,S, P, G
                        - 240-203 COMP ENG SOFTWARE LAB II <br>
                        - 240-204 COMP ENG HARDWARE LAB II<br><br>

                        มีรายวิชาเรียนก่อน ที่ต้องเรียนผ่านได้เกรด
                        <br>A, B+, B, C+ , C, D+, D, E, T, U, S, P, G, F, R, NULL<br>
                    - 240-308 COMP ENG PROJECT PREP</p>
                </a>

                <a  class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">240-402 <span class="text-sm">3(0-9-0)</span></h5>
                    <h5 class="text-center mb-2 text-sm font-bold tracking-tight text-gray-900 dark:text-white">COMPUTER ENGINEERING PROJECT II</h5>
                    <p class="font-normal text-gray-700 dark:text-gray-400">มีรายวิชาเรียนก่อน ที่ต้องเรียนผ่านได้เกรด <br>
                    A, B+, B, C+ ,C ,D+ ,D ,T ,S, P, G <br>
                    - 240-401 COMP ENGINEERING PROJECT I</p>
                </a>
            </div>
